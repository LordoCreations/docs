...
```java
public float[] getSquaredStickInputs() {
...
<img className="block h-32 dark:hidden" src="/images/light_curve.png" />
<img className="hidden h-32 dark:block" src="/images/dark_curve.png" />